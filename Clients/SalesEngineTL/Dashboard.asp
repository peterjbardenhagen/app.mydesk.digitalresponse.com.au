...
<body class="tl-bg-light">
	<div class="tl-main">
		...
		<div class="tl-quick-actions">
			...
			<a href="<%= strWorkingDir %>/Portal/LogOff.asp" class="tl-action-btn" style="border-color: #e74c3c; background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%);" target="_parent">
				<svg class="tl-action-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
