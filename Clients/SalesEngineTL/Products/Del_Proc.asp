...
sql = "Select * From QuoteContents Where ProductId = " & lngId
Set rs = dbConn.Execute(sql)

If Not(rs.BOF And rs.EOF) Then
	strErrorDescription = "The record cannot be deleted or changed because table..."
Else
	sql = "Delete From Products Where ProductId = " & lngId
	dbConn.Execute(sql)
