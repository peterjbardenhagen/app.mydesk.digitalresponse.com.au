...
Sub SendMail(strFromFax, strToFax, strSubject, strBody)
	...
	With Flds
        ...
        .Item(cdoSendUsername) = "external@digitalresponse.com.au" 
	...
	With objCDO
		...
		.Subject = strSubject
		.HtmlBody = strBody
		.AddAttachment(Server.MapPath(Request.Cookies("ClientSettings")("WorkingDir") & "/Quotes/Files") & "\" & lngQid & "\Quote.pdf")
		If rsQu("QuoteCOSId") > 0 Then
