			...
			<td>
				...
				<br/><br/>
					<table cellpadding=5 cellspacing=0 border=0 ID="Table2">
						...
						<tr>
							<td valign="top" colspan=2><b>Select a division:</b></td>
						</tr>
						<tr>
							<td valign="top" class="TDAReq" style="font-weight:bold;">Division</td>
							<td valign="top">
...
%>
						...
						<tr>
							<td colspan=2 valign="top" align="right"><input type="button" value="Cancel" onclick="if(confirm('Are you sure you want to cancel?')){document.location.href='default.asp';};"> <input type="submit" value="Next" ID="Submit2" NAME="Submit1"></td>
						</tr>
						</form>
					</table>
				</td>
