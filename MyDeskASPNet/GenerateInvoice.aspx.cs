    ...
    public partial class GenerateInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (invoiceId > 0)
            {
				...
				{
					wcUrl = protocol + "://" + Request.ServerVariables["SERVER_NAME"] + ":" + Request.ServerVariables["SERVER_PORT"] + "/ScrapeToPDF.aspx?system=" + system + "&module=Invoice&url=" + protocol + "://" + host + workingDir + "/Invoices/View.asp?invoiceId=" + invoiceId.ToString();
				}
				else
				{
					wcUrl = protocol + "://" + Request.ServerVariables["SERVER_NAME"] + ":" + Request.ServerVariables["SERVER_PORT"] + "/MyDeskASPNet/ScrapeToPDF.aspx?system=" + system + "&module=Invoice&url=" + protocol + "://" + host + workingDir + "/Invoices/View.asp?invoiceId=" + invoiceId.ToString();
				}
