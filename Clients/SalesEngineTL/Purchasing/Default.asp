<% 
' Techlight MyDesk - Modern Purchasing Navigation Hub
...
%>
	...
	<div class="tl-grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; padding: 24px;">
		<div class="tl-card" style="padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px; background: white;">
			...
			<a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/RFQ/" class="tl-btn-primary" target="_top" style="display: inline-block;">Go to RFQ</a>
		</div>
		<div class="tl-card" style="padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px; background: white;">
			<h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 600; color: #1a1a1a;">
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align: middle; margin-right: 8px;">
			...
			<a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/PurchaseOrders/" class="tl-btn-primary" target="_top" style="display: inline-block;">Go to Purchase Orders</a>
		</div>
	</div>
</div>
</body>
