		...
		<script language="javascript">
			function DoSelect() {
				if(checkForm()){
					...
					DeliveryAddress_Select(s, myForm("Company").value, myForm("Address1").value, myForm("Address2").value, myForm("Suburb").value, myForm("StateId").value, sState, myForm("PostCode").value, myForm("Country").value);
					window.close();
				}
			}
			function DoTBA() {
                DeliveryAddress_Select('To be advised', '', 'To be advised', '', '', 9, '', '', '');
			    window.close();
			}
...
<!--#include virtual="/System/ssi_Header.inc"-->
		<table width="100%" cellpadding=15 cellspacing=0 border=0>
			<tr>
				<td style="font-size:16px;" colspan=10>Delivery Address Builder</td>
			</tr>
...
<!--				<input type="button" value="Create New Contact" onclick="CreateNewContact('<%= Request.Cookies("ClientSettings")("WorkingDir") %>', 'ContactId', 'Supplier');">-->
				<input type="button" value="Invoice Address" onclick="document.location.href='DeliveryAddress.asp?Type=Main&ContactId='+document.Form1.ContactId.value;">
				<input type="button" value="Other/Delivery Address" onclick="document.location.href='DeliveryAddress.asp?Type=Other&ContactId='+document.Form1.ContactId.value;">
				</td>
			</tr>
			<tr>
				<td colspan=5>
...
%>
					<table cellpadding=2 cellspacing=0 border=0>
						<tr>
							...
							<td valign="top"><input type="text" name="Company" style="width:280px;" maxlength=50 ID="Text9"></td>
						</tr>
						<tr>
							<td valign="top" class="Req">*</td>
...
%>
					<table cellpadding=2 cellspacing=0 border=0 ID="Table1">
						<tr>
							<td valign="top" class="Req">*</td>
							<td valign="top" style="font-weight:bold;">Company</td>
							<td valign="top"><input type="text" name="Company" style="width:280px;" maxlength=50 ID="Text20" value="<%= rs("Company") %>"></td>
						</tr>
						<tr>
							<td valign="top"></td>
							<td valign="top" style="font-weight:bold;">Address 1</td>
