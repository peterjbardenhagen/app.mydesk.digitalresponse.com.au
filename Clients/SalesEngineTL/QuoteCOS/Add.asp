...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="../Setup">Setup</a> / <a href="Default.asp">Conditions of Sale</a> / Add File /></span>
				<br/><br/>
						...
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								...
								<tr>
									...
									<td valign="middle" style="font-weight:bold;"><table cellpadding=0 cellspacing=0 border=0><tr><td style="font-weight:bold;"><img src="/Images/Spacer.gif" width=100 height=1 border=0 alt=""><br>Description</td><td>&nbsp;&nbsp;</td><td><input type="text" name="QuoteCOS" size=30 maxlength=50 ID="Text1"></td></tr></table></td>
									<td valign="middle"><table cellpadding=0 cellspacing=0 border=0 ID="Table3"><tr><td width=20><img src="/Images/Spacer.gif" width=20 height=1 border=0 alt=""></td><td style="font-weight:bold;"><img src="/Images/Spacer.gif" width=25 height=1 border=0 alt=""><br>File</td><td>&nbsp;&nbsp;</td><td><INPUT TYPE=FILE SIZE=20 NAME="QuoteCOSFile" ID="QuoteCOSFile"></td></tr></table></td>
								</tr>
								<tr>
