...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Setup">Setup</a> / <a href="Default.asp">Expense Type Groups</a> / Add Expense Type Group /></span>
				<br/><br/>
						...
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								...
								<tr>
									...
									<td valign="top"><input type="text" size=50 maxlength=50 name="ExpenseTypeGroup" id="ExpenseTypeGroup" style="width:280px;"></td>
								</tr>
								<tr>
