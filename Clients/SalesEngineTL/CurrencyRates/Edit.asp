...
Dim intCurrencyId
intCurrencyId = CLng(Request("CurrencyId"))
...
sql = "Select * From [Currency] Where CurrencyId = " & intCurrencyId
...
%>
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Setup">Setup</a> / <a href="Default.asp">Currency Rates</a> / Edit Currency /></span>
				<br/><br/>
					...
					<tr>
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								...
								<input type="hidden" value="<%= rs("CurrencyId") %>" name="CurrencyId">
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Currency Name</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="CurrencyName" style="width:280px;" ID="Text1" value="<%= rs("CurrencyName") %>"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Currency Prefix</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="CurrencyPrefix" style="width:280px;" ID="Text2" value="<%= rs("CurrencyPrefix") %>"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Currency Rate</td>
									<td valign="top"><input type="text" size=50 maxlength=4 name="CurrencyRate" style="width:280px;" ID="Text3" value="<%= rs("CurrencyRate") %>"></td>
								</tr>
								<tr>
