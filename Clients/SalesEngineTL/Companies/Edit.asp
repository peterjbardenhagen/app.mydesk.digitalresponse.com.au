...
sql = "Select * From Companies Where CompanyId = " & intCompanyId
...
%>
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Setup">Setup</a> / <a href="Default.asp">Companies</a> / Edit Company /></span>
				<br/><br/>
				<table width=100% align="center" ID="Table1">
					<tr>
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								<form action="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Companies/Edit_Proc.asp" method="post" name="Form1" ID="Form1" onSubmit="return checkForm();">
								<input type="hidden" value="<%= rs("CompanyId") %>" name="CompanyId">
								<tr>
									<td valign="top" class="Req"></td>
									<td valign="top" style="font-weight:bold;">Customer Code</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="CustomerCode" id="CustomerCode" style="width:280px;" value="<%= rs("CustomerCode") %>"></td>
								</tr>
								<tr>
									<td valign="top" class="Req"></td>
									<td valign="top" style="font-weight:bold;">Supplier Code</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="SupplierCode" id="Text2" style="width:280px;" value="<%= rs("SupplierCode") %>"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Company</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="Company" id="Text1" style="width:280px;" value="<%= rs("Company") %>"></td>
								</tr>
								<tr>
