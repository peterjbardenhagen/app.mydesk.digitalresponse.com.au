...
<!--#include virtual="/System/ssi_Header.inc"-->
	<center>
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table5">
		<tr>
			<td>
				<br>
				<table width="100%" cellpadding=0 cellspacing=0 border=0 ID="Table6">
					<tr>
						<td>
						<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / Call Reports /></span>
						</td>
						<td align="right"><a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/CallReports/Add.asp" class="Header2">Add Call Report</a></td>
					</tr>
				</table>
<%
If strMsg <> "" Then
%>
				<br>
				<table width="100%" cellpadding=3 cellspacing=0 border=0 bgcolor="#ffffff" ID="Table10">
					<tr>
						...
						<td>
							<fieldset style="width:750px;">
								...
								<table width="100%" cellpadding=5 cellspacing=0 border=0 ID="Table2">
									<form name="FormReport" id="FormReport" method="post" action="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/CallReports/IFrame.asp" target="MyIFrame">
									<tr>
...
%>
				...
				<table width=100% cellpadding=0 cellspacing=0 border=0 ID="Table9">
					<tr>
						<td>
					<iframe width=100% height=250 src="IFrame.asp?Cache=<%= rnd() %>&Sort=<%= strSort %>&CurPage=<%= CurPage %>&Code=<%= strFilter_Code %>&Company=All&DateFrom=<%= dteDateFrom %>&DateTo=<%= dteDateTo %>" name="MyIFrame" id="MyIFrame"></iframe>
						</td>
					</tr>
				</table>
			</td>
