...
<html>
	...
	<body Marginheight=0 Marginwidth=2 topMargin=0 leftMargin=2>
		...
		<table class="NoPrint" ID="Table13">
			<tr>
				<td class="Header4">Email Request For Quote</td>
			</tr>
		</table>
		<br class="NoPrint">
		<table width=400 cellpadding=5>
			...
			<tr>
				...
				<td align="right"><input type="text" name="ToEmail" style="width:250px;"> <input type="button" onclick="SelectEmailFromContacts('<%= Request.Cookies("ClientSettings")("WorkingDir") %>');" value="Select email address from contacts" /></td>
			</tr> 
			<tr>
