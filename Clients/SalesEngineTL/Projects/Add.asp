...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Setup">Setup</a> / <a href="Default.asp">Projects</a> / Add Project /></span>
				<br/><br/>
...
%>
								...
								<tr>
									...
									<td valign="top"><input type="text" size=50 maxlength=50 name="Project" id="Text1" style="width:280px;"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Visible</td>
									<td valign="top">
										<input type="radio" name="Visible" value="-1" checked ID="Radio1"> Yes<br/>
										<input type="radio" name="Visible" value="0" ID="Radio2"> No
									</td>
								</tr>
								<tr>
