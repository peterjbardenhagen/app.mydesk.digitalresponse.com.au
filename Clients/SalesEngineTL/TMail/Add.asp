...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="Default.asp" class="Header2">T-Mail</a> / Add Message /></span>
				<br/><br/>
...
%>
								...
								<tr>
									...
									<td valign="top"><input type="text" size=50 maxlength=50 name="Subject" id="Subject" style="width:280px;"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
