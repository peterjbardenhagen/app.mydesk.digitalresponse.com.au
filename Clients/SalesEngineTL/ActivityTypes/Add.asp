...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / <a href="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/Setup">Setup</a> / <a href="Default.asp">Activity Types</a> / Add Activity Type /></span>
				<br/><br/>
						...
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								...
								<tr>
									...
									<td valign="top"><input type="text" size=50 maxlength=50 name="ActivityCode" id="ActivityCode" style="width:280px;"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Activity Type</td>
									<td valign="top"><input type="text" size=50 maxlength=50 name="ActivityType" id="Text1" style="width:280px;"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Form Required</td>
									<td valign="top">
										<input type="radio" name="FormRequired" value="-1" checked ID="Radio3"> Yes<br/>
										<input type="radio" name="FormRequired" value="0" ID="Radio4"> No
									</td>
								</tr>
								<tr>
