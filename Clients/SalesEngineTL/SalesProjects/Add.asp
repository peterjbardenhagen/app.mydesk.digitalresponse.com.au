...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp">Home</a> / <a href="Default.asp" class="Header2">Sales Projects</a> / Add Sales Project /></span>
				<br/><br/>
				<table width=100% align="center" ID="Table1">
					<tr>
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								<form action="<%= Request.Cookies("ClientSettings")("WorkingDir") %>/SalesProjects/Add_Proc.asp" method="post" name="Form1" ID="Form1" onSubmit="return checkForm();">
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Prospect Date</td>
									<td valign="top"><input type="input" value="" name="ProspectDate" readonly ID="Input2"> <a href="javascript:showCal('Calendar12')"><img src="/Images/Calendar.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Clear" onclick="document.Form1.ProspectDate.value = '';" ID="Button3" NAME="Button3"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Tender/Quote Date</td>
									<td valign="top"><input type="input" value="" name="TenderDate" readonly ID="Input3"> <a href="javascript:showCal('Calendar13')"><img src="/Images/Calendar.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Clear" onclick="document.Form1.TenderDate.value = '';" ID="Button2" NAME="Button2"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Accepted Date</td>
									<td valign="top"><input type="input" value="" name="AcceptedDate" readonly ID="Input4"> <a href="javascript:showCal('Calendar14')"><img src="/Images/Calendar.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Clear" onclick="document.Form1.AcceptedDate.value = '';" ID="Button1" NAME="Button1"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Rejected Date</td>
									<td valign="top"><input type="input" value="" name="RejectedDate" readonly ID="Input5"> <a href="javascript:showCal('Calendar15')"><img src="/Images/Calendar.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Clear" onclick="document.Form1.RejectedDate.value = '';"></td>
								</tr>
								<tr>
...
sql = "SELECT *, Company As CompanyName FROM Contacts_WithCustomers WHERE Code = '" & Request.Cookies("UserSettings")("Code") & "' ORDER BY Company, Surname, FirstName"
...
%>
								...
								<tr>
									...
									<td valign="top"><input type="text" name="Project" style="width:280px;" ID="Text1" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Product/Service</td>
									<td valign="top">
									<textarea name="Product" id="Product" rows="5" cols="30" onkeyup="parent.TrackCount(this,'textcount1',500)" onkeypress="parent.LimitText(this,500)"></textarea><br/>Characters Remaining: <input type="text" name="textcount1" size="4" value="500" readonly ID="Text2">
									</td>								
								</tr>
								<tr>
									<td valign="top"></td>
									...
									<td valign="top">
										<input type="radio" name="OneOffSalesProject" value="-1" checked> Yes<br/>
										<input type="radio" name="OneOffSalesProject" value="0"> No
									</td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">If one off then<br>Value</td>
									<td valign="top">$<input type="text" size=20 name="Value" id="Value" maxlength=10></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">If ongoing then<br>Amount Per Month</td>
									<td valign="top">$<input type="text" size=20 name="AmountPerMonth" id="Text5" maxlength=10></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">If ongoing then<br>Expected Number of Months</td>
									<td valign="top"><input type="text" size=4 name="NumberOfMonths" id="Text3" maxlength=8></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Potential Order Date</td>
									<td valign="top"><input type="input" value="" name="PotentialOrderDate" readonly ID="Input1"> <a href="javascript:showCal('Calendar8')"><img src="/Images/Calendar.gif" border=0></a></td>
								</tr>
								<tr>
									<td valign="top"></td>
