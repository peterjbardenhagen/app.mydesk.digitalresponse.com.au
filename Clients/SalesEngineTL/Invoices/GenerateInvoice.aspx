    ...
    <body>
        <script language="visualbasic" runat="server">
            ...
            Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                ...
                Dim oRequest As WebRequest = WebRequest.Create(strProtocol & "://" & Request.ServerVariables("SERVER_NAME") & strWorkingDir & "/Invoices/View.asp?Email=" & boolEmail & "&Fax=" & boolFax & "&InvoiceId=" & lngInvoiceId & "&CurrencyName=" & strCurrencyName & "&CurrencyRate=" & dblCurrencyRate & "&CurrencyPrefix=" & strCurrencyPrefix)
