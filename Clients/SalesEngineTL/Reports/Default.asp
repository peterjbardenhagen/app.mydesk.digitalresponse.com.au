...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp" class="Header2">Home</a> / Reports /></span>
...
%>
							<table width="100%" cellpadding=3 cellspacing=0 border=0 ID="Table3">
								<tr>
									<td>
									<br>
									<li><a href="SalesReportGen.asp">Sales Report</a></li><br><img src="/Images/Spacer.gif" width=200 height=5 border=0 alt=""><br>
									<li><a href="PurchaseOrders_ByMonth_ByDivision.asp">Purchase Orders By Month By Division</a></li>
									</td>
								</tr>
							</table>
						</td>
