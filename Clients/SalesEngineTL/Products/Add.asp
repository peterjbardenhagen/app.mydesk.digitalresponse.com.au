...
<!--#include virtual="/System/ssi_Header.inc"-->
	...
	<table width=95% align="center" cellpadding=0 cellspacing=0 border=0 ID="Table4">
		<tr>
			<td>
				<br/>
				<span class="Header2"><a href="/Portal.asp">Home</a> / <a href="Default.asp" class="Header2">Products</a> / Add Product /></span>
				<br/><br/>
...
%>
								...
								<tr>
									...
									<td valign="top"><input type="text" name="ProductCode" style="width:280px;" ID="Text1" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Product Name</td>
									<td valign="top"><input type="text" name="ProductName" style="width:280px;" ID="Text3" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Product Description</td>
									<td valign="top">
									<textarea name="ProductDesc" rows="5" cols="30" onkeyup="parent.TrackCount(this,'textcount1',500)" onkeypress="parent.LimitText(this,500)"></textarea><br/>Characters Remaining: <input type="text" name="textcount1" size="4" value="500" readonly ID="Text2">
									</td>								
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									...
									<td valign="top">
										<input type="radio" name="PerUnitPerDay" id="PerUnitPerDay" value="-1"> Yes<br/>
										<input type="radio" name="PerUnitPerDay" id="PerUnitPerDay" value="0" checked> No
									</td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Unit Cost (Ex. GST)</td>
									<td valign="top">$<input type="text" size=20 name="UnitCost" maxlength=8 value="0.00"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Nett Price (Ex. GST)</td>
									<td valign="top">$<input type="text" size=20 name="NettPrice" maxlength=8 value="0.00"></td>
								</tr>
								<tr>
									<td valign="top" class="Req">*</td>
									<td valign="top" style="font-weight:bold;">Minimum Nett Price (Ex. GST)</td>
									<td valign="top">$<input type="text" size=20 name="MinNettPrice" maxlength=8 value="0.00" ID="Text4"></td>
								</tr>
								<tr>
