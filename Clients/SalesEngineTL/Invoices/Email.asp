...
<html>
	...
	<body Marginheight=0 Marginwidth=2 topMargin=0 leftMargin=2>
		...
		<table class="NoPrint" ID="Table13">
			<tr>
				<td class="Header4">Email Invoice</td>
			</tr>
		</table>
		<br class="NoPrint">
		<table width=400 cellpadding=5>
			...
			<tr>
				...
				<td style="text-align:left;vertical-align:top;"><input type="text" name="Attention" style="width:250px;" ID="Text2" value="<%= rsInv("Attention") %>"></td>
			</tr>
			<tr>
				<td nowrap style="font-weight:bold;vertical-align:top;">Notes <small>These notes will appear in the email</small></td>
				<td style="text-align:left;vertical-align:top;"><textarea name="Notes" style="width:500px;height:100px;" ID="Textarea1"><%= rsInv("CN") %></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
...
%>
			...
			<tr>
				...
				<td align="right" nowrap><input type="text" name="ToEmail" value="<%= email %>" style="width:250px;">&nbsp;<input type="button" value="Set to my email" onclick="document.forms[0].ToEmail.value = '<%= Request.Cookies("UserSettings")("Email") %>';" /></td>
			</tr> 
			<tr>
