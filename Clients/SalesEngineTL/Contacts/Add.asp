						...
						<td>
							<table cellpadding=3 cellspacing=0 border=0 ID="Table2">
								...
								<tr>
									...
									<td width=170 valign="top" style="font-weight:bold;">First Name</td>
								...
								<tr>
									...
									<td valign="top"><input type="text" name="Address1" style="width:280px;" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Address 2</td>
									<td valign="top"><input type="text" name="Address2" style="width:280px;" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Suburb</td>
									<td valign="top"><input type="text" name="Suburb" style="width:280px;" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top"></td>
...
%>
								...
								<tr id="StateTR">
									...
									<td valign="top"><input type="text" name="State" style="width:280px;" maxlength=50 ID="Text1"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Post Code</td>
									<td valign="top"><input type="text" name="PostCode" style="width:280px;" maxlength=50></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Country</td>
									<td valign="top"><input type="text" name="Country" style="width:280px;" maxlength=50 ID="Text9"></td>
								</tr>
								<tr>
								...
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Address 1</td>
									<td valign="top"><input type="text" name="OAddress1" style="width:280px;" maxlength=50 ID="Text2"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Address 2</td>
									<td valign="top"><input type="text" name="OAddress2" style="width:280px;" maxlength=50 ID="Text3"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Suburb</td>
									<td valign="top"><input type="text" name="OSuburb" style="width:280px;" maxlength=50 ID="Text5"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">State</td>
...
%>
								...
								<tr id="OStateTR">
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">If other, enter State</td>
									<td valign="top"><input type="text" name="OState" style="width:280px;" maxlength=50 ID="Text6"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Post Code</td>
									<td valign="top"><input type="text" name="OPostCode" style="width:280px;" maxlength=50 ID="Text7"></td>
								</tr>
								<tr>
									<td valign="top"></td>
									<td valign="top" style="font-weight:bold;">Country</td>
									<td valign="top"><input type="text" name="OCountry" style="width:280px;" maxlength=50 ID="Text8"></td>
								</tr>
								<tr>
									<td colspan=3><br></td>
								</tr>
