...
Response.Redirect("GenerateQuote.aspx?Mode=" & intMode & "&Qid=" & lngQid & "&Attention=" & strAttention & "&ToEmail=" & strToEmail & "&FromFax=" & strFromFax & "&ToFax=" & strToFax & "&WorkingDir=" & strWorkingDir)
